namespace eRNI.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            //            projectClosed = c.DateTime(),
            //            projectLastActivity = c.DateTime(),
            //            projectLeader = c.String(maxLength: 80),
            ...
            //            localizationMapNo = c.String(nullable: false, maxLength: 10),
            ...
            //            localizationRegion = c.String(nullable: false, maxLength: 100),
            ...
            CreateTable(
                ...
                c => new
                    {
                        addresseeID = c.Int(nullable: false, identity: true),
                        addresseeName = c.String(nullable: false, maxLength: 255),
                        addresseeHouseNo = c.String(nullable: false, maxLength: 10),
                        addresseeAptNo = c.String(maxLength: 10),
                        addresseePhone = c.String(maxLength: 20),
                        addresseeCellPhone = c.String(maxLength: 20),
                        addresseePostOffice = c.String(nullable: false, maxLength: 80),
                        addresseeZipCode = c.String(nullable: false, maxLength: 6),
                        addresseeEmail = c.String(maxLength: 100),
                        addresseeCity = c.String(nullable: false, maxLength: 80),
                        streetID = c.Int(),
                    })
                .PrimaryKey(t => t.addresseeID)
                .ForeignKey("dbo.tblStreets", t => t.streetID)
                .Index(t => t.streetID);
            
            CreateTable(
                "dbo.tblDocumentsTemplates",
                c => new
                    {
                        documentTemplateID = c.Int(nullable: false, identity: true),
                        documentTemplateName = c.String(nullable: false, maxLength: 255),
                    })
                .PrimaryKey(t => t.documentTemplateID);
            ...
            //CreateTable(
            //    "dbo.tblProjectCorrespondence",
            //    c => new
            //        {
            //            projectCorrespondenceID = c.Int(nullable: false, identity: true),
            //            projectCorrespondenceDirection = c.String(nullable: false, maxLength: 35),
            //            projectCorrespondenceSender = c.String(nullable: false, maxLength: 255),
            //            projectCorrespondenceTemplate = c.String(maxLength: 255),
            //            projectCorrespondenceDate = c.DateTime(nullable: false),
            //            projectCorrespondenceSign = c.String(nullable: false, maxLength: 100),
            //            projectCorrespondenceSubject = c.String(nullable: false, maxLength: 300),
            //            projectCorrespondenceObtainment = c.DateTime(nullable: false),
            //            projectID = c.Int(nullable: false),
            //        })
            //    .PrimaryKey(t => t.projectCorrespondenceID)
            //    .ForeignKey("dbo.tblProjects", t => t.projectID, cascadeDelete: true)
            //    .Index(t => t.projectID);
            
            //CreateTable(
            //    "dbo.tblRegulationDocumentCharges",
            //    c => new
            //        {
            //            regulationDocumentCostID = c.Int(nullable: false, identity: true),
            //            regulationDocumentName = c.String(maxLength: 100),
            //            regulationDocumentChargeDate = c.DateTime(),
            //            regulationDocumentChargeTitle = c.String(nullable: false, maxLength: 100),
            //            regulationDocumentSellerName = c.String(nullable: false, maxLength: 255),
            //            regulationDocumentFee = c.Decimal(nullable: false, storeType: "money"),
            //            regulationDocumentTax = c.Decimal(nullable: false, precision: 18, scale: 2),
            //            regulationDocumentCostAdditionalInfo = c.String(),
            //            regulationDocumentID = c.Int(nullable: false),
            //        })
            //    .PrimaryKey(t => t.regulationDocumentCostID)
            //    .ForeignKey("dbo.tblRegulationDocuments", t => t.regulationDocumentID, cascadeDelete: true)
            //    .Index(t => t.regulationDocumentID);
        ...
        //    DropForeignKey("dbo.tblRegulationDocumentCharges", "regulationDocumentID", "dbo.tblRegulationDocuments");
        //    DropForeignKey("dbo.tblProjectCorrespondence", "projectID", "dbo.tblProjects");
        ...
        //    DropForeignKey("dbo.tblAddressBook", "streetID", "dbo.tblStreets");
        ...
        //    DropIndex("dbo.tblRegulationDocumentCharges", new[] { "regulationDocumentID" });
        //    DropIndex("dbo.tblProjectCorrespondence", new[] { "projectID" });
        //    DropIndex("dbo.tblKeyDocuments", new[] { "projectID" });
        //    DropIndex("dbo.tblKeyDocuments", new[] { "KeyDocumentCategoryID" });
        //    DropIndex("dbo.tblAddressBook", new[] { "streetID" });
        ...
        //    DropTable("dbo.tblRegulationDocumentCharges");
        //    DropTable("dbo.tblProjectCorrespondence");
        //    DropTable("dbo.tblKeyDocuments");
        //    DropTable("dbo.tblKeyDocumentCategories");
        //    DropTable("dbo.tblDocumentsTemplates");
        //    DropTable("dbo.tblAddressBook");
